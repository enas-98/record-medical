...
$mm4=$_SESSION["user3"];
    ...
    $sql1="SELECT * FROM  patient WHERE user_id=$mm4";
...
<th  class='tt2' width='110px'>Blood_Type</th>
<th  class='tt2'>job</th>
...
$sql5="SELECT * FROM  patient WHERE user_id='$mm4'";
  ...
  $sql2="SELECT * FROM patient ,medical_tests,patient_tests WHERE patient.id_pa=patient_tests.pa_id AND medical_tests.id_mt=patient_tests.mt_id AND patient.id_pa=$good";
$result2=mysqli_query($conection,$sql2);

$sql3="SELECT * FROM patient,diseases,patient_diseases WHERE patient.id_pa=patient_diseases.pa_id AND diseases.id_es=patient_diseases.es_id AND patient.id_pa=$good";
$result3=mysqli_query($conection,$sql3);

$sql4="SELECT * FROM patient,surgeries,patient_surgeries WHERE patient.id_pa=patient_surgeries.pa_id AND surgeries.id_su=patient_surgeries.su_id  AND patient.id_pa=$good";
