...
<style type="text/css">
  ...
  div{width: 50%;height: 725px;background-image: url(cod15.jpg);margin-left: 26%
    ;}
  ...
  #x1{width:500px;height: 40px;padding: 3px;font-size: 25px;border-style: solid;
    border-radius: 15px;border-color: black;margin-left: 15%;margin-top:8%}
  ...
  #x8{width:400px;height: 60px;padding: 3px;font-size: 25px;border-style: solid;border-radius: 15px;border-color: black;margin-left: 22%}
...
<body>
    ...
    <div>
<header><h1>Add new disease </h1></header>

  <form action="add-dis.php" method="post">
...
<option value="12"> الجهاز المناعي </option>
  ...
  <input type="input" name="z3" id="x3" placeholder="Enter-detelis">
  <br><br><br>
   <input type="input" name="ll" id="x8" placeholder="Enter-drug">
  <br><br><br>
  <input type="date" name="z4" id="x4"  placeholder="1/2/2020">
  <br><br><br>
